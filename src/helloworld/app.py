...
class HelloWorld(toga.App):
    def startup(self):
        ...
        self.fuel_label_gals = toga.Label(f"{self.fuel_slider.value / 6.7:.0f}",
                                          style=Pack(padding=(0, 5), text_align=CENTER, font_family=MONOSPACE, font_size=24, font_weight=BOLD))
        self.fuel_label_lbs = toga.Label(f"{self.fuel_slider.value:.0f}", style=Pack(padding=(0, 5), text_align=CENTER, font_family=MONOSPACE, font_size=24, font_weight=BOLD))
